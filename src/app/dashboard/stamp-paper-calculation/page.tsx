        ...
        <div>
            ...
            <div className="flex flex-col gap-y-7 mt-10">
                <div className="w-full md:w-1/3">
                    <label className="text-white font-semibold text-lg tracking-widest">STATE</label>
                    <input
                    ...
                    ></input>
                    <div hidden={stateShow} className="absolute w-1/4 remove-scroll overflow-y-scroll h-1/5 p-2 mt-1 rounded-lg bg-[#0c0c0c]">
                        {state.map((item, idx) => (
                            <div key={idx + 1} onClick={() => {
                                setState(item);
                                setStateShow(true);
                ...
                <div className="w-full md:w-1/3">
                    <label className="text-white font-semibold text-lg tracking-widest">GENDER</label>
                    <input
                        ...
                        placeholder="Gender"
                    ></input>
                    <div hidden={GenderShow} className="absolute w-1/4 remove-scroll overflow-y-scroll h-max p-2 mt-1 rounded-lg bg-[#0c0c0c]">
                        {Gender.map((item, idx) => (
                            <div key={idx + 1} onClick={() => {
                                setGender(item);
                                setGenderShow(true);
                ...
                <div className="w-full md:w-1/3">
                    <label className="text-white font-semibold text-lg tracking-widest">PROPERTY VALUE</label>
                    <input
            ...
            {FinalCharges && FinalRate &&
                <div className="mt-14 border-white text-white flex p-4 justify-center gap-y-3 items-center flex-col border-2 rounded-md">
                    ...
                    <div className="py-3">
                        <svg width="606" height="2" viewBox="0 0 606 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0.78125 0.939575L605.217 0.939522" stroke="url(#paint0_linear_144_493)" />
                            <defs>
                                <linearGradient id="paint0_linear_144_493" x1="0.78125" y1="0.939575" x2="599.386" y2="0.939523" gradientUnits="userSpaceOnUse">
                    ...
                    <div className="text-lg">
                        Rate in your state is <span className="font-semibold text-green-500">{FinalRate}%</span>
                    </div>
                </div>
            }
